...
export function unexpectedLanguageLineFormatError(
  line: WiktionaryLine,
...
export function mismatchingRedundantWordInfoError(
  line: WiktionaryLine,
): PronunciationRetrievalError {
  return {
    line,
...
export function unsupportedLanguageNameError(
  languageName: string,
  line: WiktionaryLine,
): PronunciationRetrievalError {
  return {
...
export function unsupportedLanguageCodeError(
  languageCode: string,
  line: WiktionaryLine,
): PronunciationRetrievalError {
  return {
...
export function pronunciationOutsideOfLanguageSectionError(
  line: WiktionaryLine,
): PronunciationRetrievalError {
  return {
    line,
...
export function unexpectedPronunciationLineFormatError(
  line: WiktionaryLine,
): PronunciationRetrievalError {
  return {
    line,
...
export function unexpectedTemplateArgumentCountError(
  args: string[],
  line: WiktionaryLine,
): PronunciationRetrievalError {
  return {
...
export function pronunciationOutsideOfPronunciationSectionError(
  line: WiktionaryLine,
): PronunciationRetrievalError {
  return {
    line,
